...
const char* DistributeDivDialog::columnHeadings[] = {
    "sc Address", "Shares", "SC Address", "Dividend"
};
...
bool DistributeDivDialog::ConfirmDistribution()
{
    ...
    {
        QMessageBox::critical(this, "Error", QString("Unable to get SC balance: %1").arg(error.what()));
        return false;
    }
    QString sQuestion = QString("%1 SC will be sent to %2 addresses in %3 transaction(s).\nYour current SC balance is %4.\n\nAre you sure?").arg(
