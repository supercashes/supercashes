...
QString BitcoinUnits::name(int unit)
{
    ...
    case mBTC: return QString("m-SC");
    case uBTC: return QString::fromUtf8("μ-SC");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("SC");
    case mBTC: return QString("Milli-SC (1 / 1,000)");
    case uBTC: return QString("Micro-SC (1 / 1,000,000)");
    default: return QString("???");
    }
}
