...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send shares to a sc address"));
    ...
    aboutAction->setToolTip(tr("Show information about sc"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for sc"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/peershares"), tr("Show/Hide &sc"), this);
    toggleHideAction->setToolTip(tr("Show or hide the sc window"));
    ...
    exportPeercoinKeysAction = new QAction(QIcon(":/icons/export"), tr("&Export SC keys"), this);
    exportPeercoinKeysAction->setToolTip(tr("Export the SC keys associated with the sc addresses to SC via RPC"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    notificator = new Notificator(tr("sc-qt"), trayIcon);
}
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide sc"
