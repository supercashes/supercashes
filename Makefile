#############################################################################
# Makefile for building: TCC-Qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? 8? 31 09:15:17 2016
# Project:  SC_pos-windows.pro
# Template: app
# Command: /usr/lib/i386-linux-gnu/qt4/bin/qmake USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile TCC_pos-windows.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_QRCODE -DUSE_UPNP=1 -DSTATICLIB -DLINUX -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
CFLAGS        = -pipe -static -static-libgcc -static-libstdc++ -O2 -D_REENTRANT -Wall -W $(DEFINES)
CXXFLAGS      = -pipe -static -static-libgcc -static-libstdc++ -fstack-protector -O2 -D_REENTRANT -Wall -Wextra -Wformat -Wformat-security -Wno-invalid-offsetof -Wno-sign-compare -Wno-unused-parameter $(DEFINES)
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtNetwork -I/usr/include/qt4/QtGui -I/usr/include/qt4 -Isrc -Isrc/json -Isrc/qt -Ic:/deps/miniupnpc-1.9 -Ic:/deps/boost_1_55_0 -Ic:/deps/db-4.8.30.NC/build_unix -Ic:/deps/openssl-1.0.1g/include -Ic:/deps/qrencode-3.4.3 -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -fstack-protector -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu -lqrencode -Lc:/deps/miniupnpc-1.9 -lminiupnpc -lrt -Lc:/deps/boost_1_55_0/stage/lib -Lc:/deps/db-4.8.30.NC/build_unix -Lc:/deps/openssl-1.0.1g -Lc:/deps/qrencode-3.4.3/.libs -lssl -lcrypto -ldb_cxx -lboost_system-mgw49-mt-s-1_55 -lboost_filesystem-mgw49-mt-s-1_55 -lboost_program_options-mgw49-mt-s-1_55 -lboost_thread-mgw49-mt-s-1_55 -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: TCC_pos-windows.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile TCC_pos-windows.pro
...
dist: 
	@$(CHK_DIR_EXISTS) build/TCC-Qt0.1.0.0 || $(MKDIR) build/TCC-Qt0.1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/TCC-Qt0.1.0.0/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_en.ts build/TCC-Qt0.1.0.0/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/addressbookpage.h src/qt/messagepage.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/compat.h src/util.h src/uint256.h src/serialize.h src/strlcpy.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/irc.h src/mruset.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/qtipcserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/kernel.h src/distribution.h src/qt/distributedivdialog.h src/qt/qrcodedialog.h build/TCC-Qt0.1.0.0/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/TCC-Qt0.1.0.0/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/addressbookpage.cpp src/qt/messagepage.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/version.cpp src/util.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/irc.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/json/json_spirit_writer.cpp src/json/json_spirit_value.cpp src/json/json_spirit_reader.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/qtipcserver.cpp src/qt/rpcconsole.cpp src/kernel.cpp src/distribution.cpp src/scanbalance.cpp src/qt/distributedivdialog.cpp src/qt/qrcodedialog.cpp build/TCC-Qt0.1.0.0/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/messagepage.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/distributedivdialog.ui src/qt/forms/qrcodedialog.ui build/TCC-Qt0.1.0.0/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_en.ts build/TCC-Qt0.1.0.0/ && (cd `dirname build/TCC-Qt0.1.0.0` && $(TAR) TCC-Qt0.1.0.0.tar TCC-Qt0.1.0.0 && $(COMPRESS) TCC-Qt0.1.0.0.tar) && $(MOVE) `dirname build/TCC-Qt0.1.0.0`/TCC-Qt0.1.0.0.tar.gz . && $(DEL_FILE) -r build/TCC-Qt0.1.0.0
...
src/qt/locale/bitcoin_en.qm: src/qt/locale/bitcoin_en.ts
	/usr/lib/i386-linux-gnu/qt4/bin/lrelease src/qt/locale/bitcoin_en.ts
...
build/moc_distributedivdialog.cpp: src/util.h \
	...
	/usr/lib/i386-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/distributedivdialog.h -o build/moc_distributedivdialog.cpp
...
build/optionsdialog.moc: src/qt/optionsdialog.h \
		...
		src/qt/optionsdialog.cpp
	/usr/lib/i386-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/optionsdialog.cpp -o build/optionsdialog.moc
...
build/ui_distributedivdialog.h: src/qt/forms/distributedivdialog.ui
	/usr/lib/i386-linux-gnu/qt4/bin/uic src/qt/forms/distributedivdialog.ui -o build/ui_distributedivdialog.h
